    ...
    <>
      ...
      <main className="wrap">
        ...
        <div className="callout">
          <strong>Trellis placement affects root volume needs.</strong> A vertical trellis inside the same container reduces the effective soil area the roots can spread into sideways — if you&apos;re training a vining variety upward in a container, size up slightly from the base recommendation to compensate for the space the support structure occupies underground.
        </div>
        ...
        <div className="faq-item"><div className="faq-q">Can bush and vining cucumbers share a container?</div><p className="faq-a">Not recommended — their root competition patterns differ enough that the vining variety typically outcompetes the bush plant for water and nutrients within a few weeks.</p></div>
